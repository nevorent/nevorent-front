...
export function SistemIcon() {
    return (
        <SvgIcon sx={{ height: 32, width: 160, mr: 2 }} viewBox="0 0 160 32">
            <svg
                width="160"
                height="32"
                viewBox="0 0 160 32"
            ...
            >
                {/* Iconița stilizată: O casă modernă formată din forme geometrice */}
                <path
                    d="M16 2L2 12V26C2 27.1046 2.89543 28 4 28H12V18H20V28H28C29.1046 28 30 27.1046 30 26V12L16 2Z"
                    fill="#4876EE"
                />
                <path
                    d="M16 2L30 12H20V5L16 2Z"
                    fill="#00D3AB"
                />
